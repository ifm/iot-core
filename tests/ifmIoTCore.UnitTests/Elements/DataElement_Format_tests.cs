namespace ifmIoTCore.UnitTests.Elements
{
    ...
    class DataElement_Format_tests
    {
        ...
        {// this test was made NOT mandatory for embedded devices behavior 
            Assert.DoesNotThrow(() =>
            {
                IDataElement testElement = new DataElement<object>(null, "data0",
                    format: new Format("", "", null, "")); // Format Base constructor exposed or does not do validation 
            });
        ...
        public void Format_types_Basic_CanBeCreated()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(
                    new DataElement<object>(null, "booleanFormat",
                        format: new BooleanFormat(ns: "JSON")).Format.Type,
                    Is.EqualTo(Format.Types.Boolean));

                Assert.That(
                    new DataElement<object>(null, "IntegerFormat",
                        format: new IntegerFormat(new IntegerValuation(0), ns: "JSON")).Format.Type,
                    Is.EqualTo(Format.Types.Number));

                Assert.That(
                    new DataElement<object>(null, "FloatFormat",
                        format: new FloatFormat(new FloatValuation(0.0f), ns: "JSON")).Format.Type,
                    Is.EqualTo(Format.Types.Number));

                Assert.That(
                    new DataElement<object>(null, "data0",
        ...
        public void Format_types_Complex_CanBeCreated()
        {
            Assert.Multiple(() =>
            {
                // array, enum, object 
                Assert.That(
                    new DataElement<object>(null, "arrayFormat", 
                ...
                Assert.That(
                    new DataElement<object>(null, "integerEnumFormat",
                ...
                Assert.That(
                    new DataElement<object>(null, "object1",
        ...
        public void Format_encodings_CanBeUsed()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(
                    new DataElement<object>(null, "hexstringEncoding",
        ...
        {
            IDataElement de = new DataElement<object>(null, "data0", 
        ...
        public void Format_namespace_defaultsToJson()
        {
            Assert.Multiple(() => { 
                ...
                IDataElement de2 = new DataElement<object>(null, "data0",
        ...
        public void Format_namespace_any_string_accepted()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.DoesNotThrow(() =>
                {
                    var de1 = new DataElement<object>(null, "data0",
        ...
        public void Format_valuations_all_members_defined_in_baseClassValuation()
        {
            ...
            var de1 = new DataElement<object>(null, "valcheck", format: new Format("customtype", "customencoding", valuationInstance, ns:"JSON"));
            Assert.Multiple(() =>
            {
                foreach (var name in ValuationProperties.Keys)
                {
                    var exptype = ValuationProperties[name];
                    var actualProperty = de1.Format.Valuation.GetType().GetField(name);
                    Assert.NotNull(actualProperty, "property not found in Valuation: '{0}' ", name);
                    Assert.AreEqual(exptype, actualProperty.FieldType, "type mismatched for property '{0}'", name);
                }
            });
        }
        ...
        public void Format_valuation_DerivedTypeMembersAreUsable_IntegerValuation()
        {
            ...
            var de1 = new DataElement<object>(null, "valcheck", format: new Format("customtype", "customencoding", valn, ns:"JSON"));
