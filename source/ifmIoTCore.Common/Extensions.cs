namespace ifmIoTCore.Common
{
    ...
    public static class Extensions
    {
        ...
        /// <summary>Gets the part of the string left of the first occurrence of the separator string</summary>
        /// <param name="str">The character separated string</param>
        ...
        /// <summary>Gets the part of the string right of the first occurence of the separator string</summary>
        /// <param name="str">The character separated string</param>
        /// <param name="separator">The separator string</param>
        /// <param name="startIndex">The search starting position</param>
        /// <param name="includeSeparator">If true, the separator string is included; otherwise not</param>
